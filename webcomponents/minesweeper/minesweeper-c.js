(function(h) {
    ...
    h.fn.minesweeper = function() {
        ...
        i.start = function() {
            ...
            j.reveal = function(a, b) {
                if (!(a.isFlagged || b && a.isRevealed))
                    ...
                    if (c = n(a, function(a) {
                        ...
                        d = n(a, function(a) {
                            return !a.isRevealed && !a.isFlagged
                        });
            ...
            h(b).one("win", function() {
                ...
                window.setTimeout(function() {
                        document.getElementById("smiley_element").style.background = "#c0c0c0 url('cool.png') center no-repeat";
                        document.getElementById("smiley_element").style.backgroundSize = "cover !important";
                        var sound = document.getElementById("audio_win");
                        sound.pause();
                        sound.currentTime = 0;
                        sound.play();
                        gICAPI.Action('gamewinner');
                ...
                i.stop();
                window.setTimeout(function() {
                    document.getElementById("smiley_element").style.background = "#c0c0c0 url('dead.png') center no-repeat";
                    document.getElementById("smiley_element").style.backgroundSize  = "cover";
                    var sound = document.getElementById("audio");
                    sound.pause();
                    sound.currentTime = 0;
                    sound.play();
                    gICAPI.Action('gameover');
        ...
        m = $( "div" ).find(".timer");
        g.find("button.newGame").on("click", function() {
